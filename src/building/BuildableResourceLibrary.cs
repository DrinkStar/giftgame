...
/// <remarks>
///   This class is used to store an array of buildable objects that can be
///   built in the grid building system. It provides an easy way of creating
///   and managing buildable objects using multiple libraries (for testing or
///   menus etc.).
/// </remarks>
[GlobalClass]
public partial class BuildableResourceLibrary : Resource
{
  ...
  /// <summary>
  ///   Initializes a new instance of the <see cref="BuildableResourceLibrary"/>
  ///   class with an empty array of buildable objects. Empty constructor
  ///   required for Godot serialization.
  /// </summary>
  public BuildableResourceLibrary()
    : this(new BuildableResource[99]) { }

  /// <summary>
  ///   Initializes a new instance of the <see cref="BuildableResourceLibrary"/>
  ///   class with the specified array of buildable objects.
  /// </summary>
