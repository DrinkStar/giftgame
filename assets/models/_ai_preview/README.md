# `_ai_preview` — neural GLB scratch

Files in this folder are **AI-generated drafts** from the free three.ws 3D Studio lane (or local experiments). They are **not CC0** and are **not product assets**.
